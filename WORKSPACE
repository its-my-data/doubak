...
# To update the version, check https://github.com/bazelbuild/rules_go#protobuf-and-grpc.
http_archive(
...
# To update the versions, check https://github.com/bazelbuild/bazel-gazelle.
http_archive(
